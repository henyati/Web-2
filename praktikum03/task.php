...
<body>
    <div class="container">
            ...
            <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-8">
                        ...
                        <div class="custom-control custom-checkbox custom-control-inline">
                            <input name="skill[]" id="skill[]_6" type="checkbox" class="custom-control-input" value="PHP">
                            <label for="skill[]_6" class="custom-control-label">PHP</label>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
        ...
        $skill = $_POST['skill'];
        $skor = 0;
        // Buat logi nentuin skor dari skill
        foreach ($skill as $s) {
            switch ($s) {
                case 'HTML':
                    $skor += 10;
